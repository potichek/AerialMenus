...
public class StringEqualsRequirement extends Requirement {
    ...
    public StringEqualsRequirement(RequirementType type, String requirementName, List<String> denyCommands, List<String> successCommands, boolean optional, DebugService debugService) {
    ...
    public boolean check(Player player) {
        ...
        return getWithPropetryNegative(input.equalsIgnoreCase(output));
    }
